...
function big_picture_generator(number) {
    if (number >= 0 && number <= 500) {
        return "https://raw.githubusercontent.com/hank199599/Google-Assistant-APP/master/%E7%A9%BA%E6%B1%99%E6%9F%A5%E8%A9%A2%E7%B2%BE%E9%9D%88/AQI/big/" + number + ".jpg";
    } else {
        return "https://raw.githubusercontent.com/hank199599/Google-Assistant-APP/master/%E7%A9%BA%E6%B1%99%E6%9F%A5%E8%A9%A2%E7%B2%BE%E9%9D%88/AQI/big/NaN.jpg";
    }
}
...
function predict(input) {
    ...
    for (k = 0; k < input.length; k++) {
        if (input[k].AQI >= 0 && input[k].AQI <= 50) { array1.push(area_array[k]) } else if (input[k].AQI >= 51 && input[k].AQI <= 100) { array2.push(area_array[k]) } else if (input[k].AQI >= 100 && input[k].AQI <= 150) { array3.push(area_array[k]) } else if (input[k].AQI >= 151 && input[k].AQI <= 199) { array4.push(area_array[k]) } else if (input[k].AQI >= 200 && input[k].AQI <= 300) { array5.push(area_array[k]) } else if (input[k].AQI > 301) { array6.push(area_array[k]) }
    }
