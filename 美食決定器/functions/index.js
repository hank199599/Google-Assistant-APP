...
function Breakfast() { number = parseInt(Math.random() * 42);
    new Small_picker();
    chosen = i18n.__(number); }

function Lunch() { number = parseInt(43 + (Math.random() * 47));
    new Small_picker();
    chosen = i18n.__(number); }

function Afternoon_Tea() { number = parseInt(120 + (Math.random() * 43));
    new Small_picker();
    chosen = i18n.__(number); }

function Dinner() { number = parseInt(43 + (Math.random() * 47));
    new Small_picker();
    chosen = i18n.__(number); }

function Late_Night() { number = parseInt(164 + (Math.random() * 43));
    new Small_picker();
    chosen = i18n.__(number); }

function Rice() { number = parseInt(208 + (Math.random() * 19));
    new Small_picker();
    chosen = i18n.__(number); }

function Noodle() { number = parseInt(228 + (Math.random() * 20));
    new Small_picker();
    chosen = i18n.__(number); }
...
function Time_suggestion(UTCtime) {
    ...
    if (hour_now >= 4 && hour_now <= 8) {
        new Breakfast();
        type = i18n.__('Breakfast');
        icon = '🌅';
        picture_url = 'https://raw.githubusercontent.com/hank199599/Google-Assistant-APP/master/%E7%BE%8E%E9%A3%9F%E6%B1%BA%E5%AE%9A%E5%99%A8/assets/zPdcQxi.jpg';
    } else if (hour_now >= 9 && hour_now <= 10) {
        new Breakfast();
        type = i18n.__('Brunch');
        icon = '🌅';
        picture_url = 'https://raw.githubusercontent.com/hank199599/Google-Assistant-APP/master/%E7%BE%8E%E9%A3%9F%E6%B1%BA%E5%AE%9A%E5%99%A8/assets/hkO9Wd6.jpg';
    } else if (hour_now >= 11 && hour_now <= 13) {
        new Lunch();
        type = i18n.__('Lunch');
        icon = '☀️';
        picture_url = 'https://raw.githubusercontent.com/hank199599/Google-Assistant-APP/master/%E7%BE%8E%E9%A3%9F%E6%B1%BA%E5%AE%9A%E5%99%A8/assets/6C1i2Qv.jpg';
    } else if (hour_now >= 14 && hour_now <= 16) {
        new Afternoon_Tea();
        type = i18n.__('Afternoon tea');
        icon = '🌇';
        picture_url = 'https://raw.githubusercontent.com/hank199599/Google-Assistant-APP/master/%E7%BE%8E%E9%A3%9F%E6%B1%BA%E5%AE%9A%E5%99%A8/assets/8grsTJ6.jpg';
    } else if (hour_now >= 17 && hour_now <= 20) {
        new Dinner();
        type = i18n.__('Dinner');
        icon = '🌃';
        picture_url = 'https://raw.githubusercontent.com/hank199599/Google-Assistant-APP/master/%E7%BE%8E%E9%A3%9F%E6%B1%BA%E5%AE%9A%E5%99%A8/assets/XyNHWuE.jpg';
    } else {
        new Late_Night();
        type = i18n.__('Late-night supper');
        icon = '🌙';
        picture_url = 'https://raw.githubusercontent.com/hank199599/Google-Assistant-APP/master/%E7%BE%8E%E9%A3%9F%E6%B1%BA%E5%AE%9A%E5%99%A8/assets/Y4eGzDD.jpg';
    }
}
...
app.intent('預設歡迎語句', (conv) => {
    ...
    new IconEarth();
    output_food = chosen;
    if (output_food === '丼飯') { output_food = '動飯'; } else if (output_food === '刈包') { output_food = '掛包'; } else if (output_food === '蚵仔煎') { output_food = '鵝阿堅'; } else if (output_food === '碗粿') { output_food = '挖貴'; } else if (output_food === '米香') { output_food = '咪乓'; } else if (output_food === '吐司') { output_food = '土司'; } else if (output_food === '夾蛋吐司') { output_food = '夾蛋土司'; }
    ...
    if (chosen_link === '漢堡') { chosen_link = '漢堡店'; } else if (chosen_link === '總匯') { chosen_link = '總匯三明治'; }
...
app.intent('輸出想到的美食', (conv, { input }) => {
    ...
    if (conv.user.locale === "zh-HK") {
        if (input === "午餐") { input = "食晏" } else if (input === "下午茶") { input = "茶餐" }
    }

    if (input === i18n.__('Breakfast')) { type = i18n.__('Breakfast'); } else if (input === i18n.__('Lunch')) { type = i18n.__('Lunch'); } else if (input === i18n.__('Afternoon tea')) { type = i18n.__('Afternoon tea'); } else if (input === i18n.__('Dinner')) { type = i18n.__('Dinner'); } else if (input === i18n.__('Late-night supper')) { type = i18n.__('Late-night supper'); } else if (input === i18n.__('Rice')) { type = i18n.__('Rice'); } else if (input === i18n.__('Noodle')) { type = i18n.__('Noodle'); }

    if (type === i18n.__('Breakfast')) { new Breakfast();
        icon = '🌅'; } else if (type === i18n.__('Lunch')) { new Lunch();
        icon = '☀️'; } else if (type === i18n.__('Dinner')) { new Dinner();
        icon = '🌃'; } else if (type === i18n.__('Afternoon tea')) { new Afternoon_Tea();
        icon = '🌇'; } else if (type === i18n.__('Late-night supper')) { new Late_Night();
        icon = '🌙'; } else if (type === i18n.__('Rice')) { new Rice();
        icon = '🍚'; } else if (type === i18n.__('Noodle')) { new Noodle();
        icon = '🍝'; }
    ...
    if (output_string === '覺得如何ㄋ') { output_string = '覺得如何呢'; } else if (output_string === '這個如何ㄋ') { output_string = '這個如何呢'; } else if (output_string === '這個不錯八') { output_string = '這個不錯吧'; }
...
app.intent('回到預設選單', (conv) => {
    ...
    new IconEarth();
    chosen_link = chosen;
    if (output_food === '丼飯') { output_food = '動飯'; } else if (output_food === '刈包') { output_food = '掛包'; } else if (output_food === '蚵仔煎') { output_food = '鵝阿堅'; } else if (output_food === '碗粿') { output_food = '挖貴'; } else if (output_food === '米香') { output_food = '咪乓'; } else if (output_food === '吐司') { output_food = '土司'; }
...
app.intent('Google地圖查詢', (conv, { food }) => {
    ...
    if (food !== '') { chosen = food; } else { chosen = conv.user.storage.chosen; }
...
app.intent('麵或飯', (conv) => {
    ...
    if (last === choice) { choice++;
        choice = choice % 2; }
    last = choice;

    if (choice === 0) { type = i18n.__('Rice');
        I_think = i18n.__('I_think_1');
        icon = '🍚'; }
    if (choice === 1) { type = i18n.__('Noodle');
        I_think = i18n.__('I_think_2');
        icon = '🍝'; }
