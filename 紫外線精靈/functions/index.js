...
function picture_generator(number) {
    if (number == 0) { return "https://dummyimage.com/1933x1068/1e9165/ffffff.png&text=%200%20"; }
    if (number > 0 && number < 3) { return "https://dummyimage.com/1933x1068/1e9165/ffffff.png&text=" + number; } else if (number >= 3 && number < 6) { return "https://dummyimage.com/1933x1068/fc920b/ffffff.png&text=" + number; } else if (number >= 6 && number < 8) { return "https://dummyimage.com/1933x1068/ef4621/ffffff.png&text=" + number; } else if (number >= 8 && number < 11) { return "https://dummyimage.com/1933x1068/b71411/ffffff.png&text=" + number; } else if (number >= 11) { return "https://dummyimage.com/1933x1068/4f1770/ffffff.png&text=" + number; } else { return "https://dummyimage.com/1933x1068/232830/ffffff.png&text=NaN"; }
}

function status_generator(number) {
    if (number >= 0 && number < 3) { return "低量級"; } else if (number >= 3 && number < 6) { return "中量級"; } else if (number >= 6 && number < 8) { return "高量級"; } else if (number >= 8 && number < 11) { return "過量級"; } else if (number >= 11) { return "危險級"; } else { return "儀器故障或校驗"; }
    ...
    return new Promise(
        ...
        if (conv.screen) {
            ...
            if (hour_now >= 6 && hour_now <= 17) {
                picture = "https://raw.githubusercontent.com/hank199599/Google-Assistant-APP/master/%E7%B4%AB%E5%A4%96%E7%B7%9A%E7%B2%BE%E9%9D%88/assets/0Is452b.jpg";
                title = "嘆息西窗過隙駒，微陽初至日光舒";
            } else {
                picture = "https://raw.githubusercontent.com/hank199599/Google-Assistant-APP/master/%E7%B4%AB%E5%A4%96%E7%B7%9A%E7%B2%BE%E9%9D%88/assets/ejlSjF3.png";
                title = "明月，明月，胡笳一聲愁絕";
            }
